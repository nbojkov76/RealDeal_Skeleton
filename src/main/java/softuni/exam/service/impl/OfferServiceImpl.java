...
public class OfferServiceImpl implements OfferService {
    ...
    public OfferServiceImpl(OfferRepository offerRepository, ModelMapper modelMapper, ValidationUtil validationUtil, CarService carService, SellerService sellerService, XmlParser xmlParser) {
       ...
       xmlParser.fromFile(OFFER_FILE_PATH, OfferSeedRootDto.class)
               ...
               .filter(offerSeedDto -> {
                   boolean isValid = validationUtil.isValid(offerSeedDto);
                    sb.append(isValid ? String.format("Successfully import offer %s - %s", offerSeedDto.getAddedOn()
                    ,offerSeedDto.isHasGoldStatus()): "Invalid offer")
